...
- **#47 shipped after the last update via [PR #48](https://github.com/nitsuga/harness-remote/pull/48)** — the live running-subagent summary row above was added. The issue itself remains open pending final acceptance sign-off; its first-render gap (running card appears only after a full transcript reload) was filed as #52 during live validation and fixed by PRs #53 and #54.
