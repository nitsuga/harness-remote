...
export const translations: Record<LanguageCode, Partial<Record<TranslationKey, string>>> = {
  en: {
    ...
    'detail.subagentLivePlaceholder': 'No output yet — the child session is working.',
  ...
  it: {
    ...
    'detail.subagentLivePlaceholder': 'Nessun output per ora — la sessione figlia sta lavorando.',
  ...
  'zh-TW': {
    ...
    'detail.subagentLivePlaceholder': '尚無輸出 — 子工作階段正在執行中。',
  ...
  'zh-CN': {
    ...
    'detail.subagentLivePlaceholder': '暂无输出 — 子会话正在运行中。',
