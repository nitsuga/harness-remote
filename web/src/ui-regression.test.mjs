...
assert.ok(app.includes('retireOptimisticUserRows(tail)'),
  'the seed and tail refresh must retire optimistic bubbles whose server copy just landed, or a sent prompt renders twice')
