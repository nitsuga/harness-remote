...
assert.match(app, /async function send\(\)\s*\{[\s\S]*?if \(!selectedSession \|\| sessionActionPending === "fork"\) return/, 'composer submission must be blocked while a fork snapshot is pending')
